...
import (
	...
	"github.com/InjectiveLabs/injective-oracle-scaffold/injective-chain/modules/oracle"
	...
	_ "github.com/InjectiveLabs/injective-oracle-scaffold/client/docs/statik"

	"github.com/InjectiveLabs/injective-oracle-scaffold/injective-chain/app/ante"
	oraclekeeper "github.com/InjectiveLabs/injective-oracle-scaffold/injective-chain/modules/oracle/keeper"
	oracletypes "github.com/InjectiveLabs/injective-oracle-scaffold/injective-chain/modules/oracle/types"

	sidechain "github.com/InjectiveLabs/injective-oracle-scaffold/injective-chain/types"
)

func init() {
	// set the address prefixes
	config := sdk.GetConfig()
	sidechain.SetBech32Prefixes(config)
	sidechain.SetBip44CoinType(config)
...
func NewInjectiveApp(
	...
	app.AccountKeeper = authkeeper.NewAccountKeeper(
		appCodec, keys[authtypes.StoreKey], app.GetSubspace(authtypes.ModuleName), sidechain.ProtoAccount, maccPerms,
	)
...
// NOTE: This is solely to be used for testing purposes as it may be desirable
// for modules to register their own custom testing types.
func (app *InjectiveApp) AppCodec() codec.Marshaler {
	return app.appCodec
}
